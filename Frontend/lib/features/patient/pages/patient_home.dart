...
import 'package:chronocancer_ai/features/patient/pages/report_analyzer_page.dart' show ReportAnalyzerPage;
...
Widget _buildEnhancedCancerTypeCard(
  ...
  radius: 50.0,
  lineWidth: 10.0,
  percent: HealthScoreStore.score / 100,
  center: Column(
    mainAxisAlignment: MainAxisAlignment.center,
    children: [
      Text('${HealthScoreStore.score}',
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                 onPressed: () {
                  ...
                  child: const Text('Open Ai Analyzer',
                      style: TextStyle(color: Colors.white)),
                ),
              ),
